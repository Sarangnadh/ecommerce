...
export class AddProductComponent implements OnInit {
  ...
  constructor(private router:Router,private formBuilder: FormBuilder,private productservices:ProductService) { }
 ...
 this.productservices.addProduct(newproduct).subscribe((data:any)=>{
